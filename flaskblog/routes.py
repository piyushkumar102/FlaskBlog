...
from flaskblog.form import RegisterForm, LoginForm, UpdateForm, PostForm, RequestResetForm, ResetPasswordForm
...
def send_reset_email(user):
    ...
    msg = Message('Password Reset Request', sender='techstation2017@gmail.com', recipients=[user.email])
    msg.body = f'''To Reset Password, Visit Here!    
